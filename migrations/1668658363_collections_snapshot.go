		...
		jsonData := `[
			{
				...
				"updated": "2023-01-09 20:10:48.507Z",
				"name": "cards",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.509Z",
				"name": "sets",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.510Z",
				"name": "rarities",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.512Z",
				"name": "types",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.513Z",
				"name": "spellslingers",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.515Z",
				"name": "decks",
				"type": "base",
				"system": false,
				"schema": [
				...
				"createRule": "@request.auth.verified = true && @request.auth.id = owner",
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.516Z",
				"name": "subtypes",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-09 20:10:48.517Z",
				"name": "reminders",
				"type": "base",
				"system": false,
				"schema": [
			...
			},
			{
				...
				"updated": "2023-01-13 04:39:25.831Z",
				"name": "users",
				"type": "auth",
				"system": false,
				"schema": [
